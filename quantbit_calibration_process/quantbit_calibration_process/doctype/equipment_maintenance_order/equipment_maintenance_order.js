...
frappe.ui.form.on('Equipment Maintenance Order', {
...
frappe.ui.form.on('Equipment Maintenance Order', {
    refresh: function(frm) {
        frm.add_custom_button(__('Equipment Maintenance Order'), function() {
            frappe.set_route('Form', 'Equipment Maintenance Order');
        }, __('Go To Doctype'));
